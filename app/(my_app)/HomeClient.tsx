      ...
      <section className="bg-brand-secondary py-24 px-2 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          {featuredProducts.length > 0 ? (
            ...
            <div className="py-16 text-center bg-white border border-gold-500/10 rounded-sm">
              <p className="text-sm text-neutral-500">Featured jewellery is being curated.</p>
            </div>
          )}
        </div>
      </section>
